...
public class AdminVerEquipoFragment extends Fragment {

    FragmentAdminVerEquipoBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentAdminVerEquipoBinding.inflate(inflater, container, false);
